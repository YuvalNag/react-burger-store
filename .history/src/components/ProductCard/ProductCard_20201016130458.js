...
import { Card, CardActionArea, CardMedia, CardContent, Typography, Button, makeStyles, CardActions, Divider, Theme, createStyles, useTheme, IconButton } from '@material-ui/core'
...
const ProductCard = ({ title, description, price, imageSrc }) => {
    ...
    return (
        <Card className={classes.root}>
            ...
            />
            <Collapse in={hover}  >
                <CardActions onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)} style={{ alignItems: 'start' }}>
                    <IconButton >
                        <AddShoppingCartIcon />
                    </IconButton>
