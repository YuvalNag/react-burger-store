...
import { Card, CardActionArea, CardMedia, CardContent, Typography, Avatar, Button, makeStyles, CardActions, Divider, Theme, createStyles, useTheme, IconButton, Collapse, withWidth } from '@material-ui/core'
...
const ProductCard = ({ title, description, price, imageSrc,breakpoint }) => {
