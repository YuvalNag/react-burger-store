...
import { Card, CardActionArea, CardMedia, CardContent, Typography, Avatar, Button, makeStyles, CardActions, Divider, Theme, createStyles, useTheme, IconButton, Collapse, Fab } from '@material-ui/core'
...
const ProductCard = ({ title, description, price, imageSrc, onAdd, onRemove, amount }) => {
                ...
                <div className={classes.details}>
                    ...
                    <div className={classes.controls}>
                        ...
                        <CardActions style={{ alignItems: 'start' }}>
                            ...
                            <Typography align="center" color='textSecondary' variant='h5' component='p' style={{ margin: 0, alignSelf: 'center', fontWeight: 'bold' }}>
                                {amount ? amount : 0}                </Typography>
                            <IconButton onClick={onRemove} disabled={amount < 1} >
                                <RemoveIcon />
                            </IconButton>
