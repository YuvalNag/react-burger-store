...
import { Card, CardActionArea, CardMedia, CardContent, Typography, Avatar, Button, makeStyles, CardActions, Divider, Theme, createStyles, useTheme, IconButton, Collapse } from '@material-ui/core'
            ...
            <div className={classes.details}>
                ...
                <div className={classes.controls}>
                    ...
                    <CardActions style={{ alignItems: 'start' }}>
                        ...
                        <IconButton onClick={() => setAmount(prev => prev++)}>
                            <AddIcon />
                        </IconButton>
                        <Typography align="center" color='textSecondary' variant='p' component='p' style={{ margin: 0, alignSelf: 'center', fontWeight: 'bold' }}>
                            {amount}                </Typography>
                        <IconButton onClick={() => setAmount(prev => prev--)} >
                            <RemoveIcon />
                        </IconButton>
